...
module.exports = function (args) {
  ...
  args.server.url = args.server.url || 'http://localhost:1337/default'
  ...
  if (lr) {
    ...
    lr.sync = lr.sync ? ghostMode : false
    startFileWatch(lr)
  ...
  // Keep it simple for sourcemaps and append .map.json
  if (args.js.minify) {
    args.js.map = (args.js.alias || args.js.entry) + '.map.json'
  }
  ...
  http.createServer(function (req, res) {
    ...
    switch (req.url.split('?')[0]) {
      ...
      case args.js.map:
        js(args.js, responder('sourcemap', res))
        break
