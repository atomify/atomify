...
module.exports = function (args) {
  ...
  args.server.url = args.server.url || 'http://localhost:' + port + path
  baseUrl = parseBaseUrl(args.server.url)
  ...
  if (launch) open(args.server.url)
}
...
function injectLiveReloadScript (lr) {
  var buffer = ''
    , tag = '<script src="' + baseUrl + ':' + lr.port + '/livereload.js?snipver=1"></script>\n'
...
function parseBaseUrl (urlString) {
