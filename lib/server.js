...
module.exports = function (args) {
  givenArgs = arguments['0'];
  watchpaths = arguments['1']
...
function startFileWatch (lr) {
  ...
  if (givenArgs.css && givenArgs.css.watch) watchCSSimportsAndAssets();
}

function watchCSSimportsAndAssets () {
  delete watchpaths.jsEntry;
  ...
  gazeCSS.on('changed', function (filepath) {
    ...
    css(givenArgs.css, function() {console.log('bundle updated'.grey);});
  });
}
