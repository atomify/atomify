...
module.exports = function (args) {
  ...
  var mount = st(args.server.st || { path: process.cwd(), cache: false })
    ...
    , serverPath = path.normalize('/' + (args.server.path || parsedUrl.path))
  ...
  args.js = args.js || {}
  args.js.alias = path.normalize('/' + (args.js.alias || args.js.entry))
  args.css = args.css || {}
  args.css.alias = path.normalize('/' + (args.css.alias || args.css.entry))
